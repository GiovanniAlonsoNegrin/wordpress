                ...
                $text = rand(100000, 999999);
                 ...
                 if (isset($_POST[$item])) {
                     ...
                     if ($item === 'show_part_of_iframe' || $item === 'show_part_of_iframe_next_viewports_loop'
					   ...
					   || $item === 'add_iframe_url_as_param_direct'
        ...
        if ($evanto) {
          if ($is_latest) {
            echo ' <small class="hide-print"><small><small>' . __('(Your installation is up to date - <a href="//www.tinywebgallery.com/blog/advanced-iframe/advanced-iframe-history" target="_blank">view history</a>)', 'advanced-iframe') . '</small></small></small>';  
             ...
             echo ' <small class="hide-print"><small><small>' . __('(<a href="//www.tinywebgallery.com/blog/advanced-iframe/advanced-iframe-history" target="_blank">Version '.$latest_version.'</a> is available. <a href="https://codecanyon.net/downloads" target="_blank">Download</a> it from CodeCanyon and follow the <a href="https://1.envato.market/WQJ3O#item-description__upgrade" _target="blank">update instructions</a>!', 'advanced-iframe') . '</small></small></small>';
          }
        } else {
...
<?php
    ...
    $showRegMessage = !(isset($devOptions['closed_messages']) &&  isset($devOptions['closed_messages']['show-registration-message'])) && empty($devOptions['purchase_code']);
	if ($evanto && $showRegMessage) {  
		...
		echo  __('Thank you for installing advanced iframe pro. Please enter your purchase code on the <a href="#" class="enter-registration">options tab</a>.', 'advanced-iframe');
		echo '</strong></p></div>';
	} 
